...
const HistoryItem: React.FC<{ entry: HistoryEntry }> = ({ entry }) => {
  ...
  return (
    <>
      <div 
        className={`relative group bg-slate-900/80 px-2 py-1.5 rounded-md text-sm font-mono shadow-inner border border-slate-700/50 transition-all duration-300 ${textColor}`}
      >
